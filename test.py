    ...
    #
        ...
        if opt['datasets'].get('val', None) and epoch % opt['train']['val_epoch'] == 0:
            ...
            for val_data in val_loader:
                ...
                print(real_name)
                # target_root = '/home/eescut/Desktop/moe_doc_enc/output/experiments/STEN/test_images/'
                target_root = os.path.join(opt['path']['results_root'], 'experiments/STEN/test_images/')
                print(target_root)
